                            ...
                            <div class="itemList row">
                                <c:forEach items="${listBook}" var="b">
                                    <div class="item col-lg-6">
                                        <form style="height: 325px;width: 450px" action="sellerBookAction?action=bookDetail&bookId=${b.book_Id}&categoryId=${b.category}&bookName=${b.name}"
                                              method="POST">
                                            <div class="border">
                            ...
                            <div class="page row">
                                ...
                                <div class="col-lg-4 d-flex justify-content-center">
                                    ...
                                    <c:if test="${numLastBook>16}">
                                        <a type="submit" href="sellerBookAction?action=bookPage5">5</a>
                                    </c:if>
                                    <c:if test="${numLastBook>20}">
                                        <a type="submit" href="sellerBookAction?action=bookPage6">6</a>
                                    </c:if>
                                </div>
                                <div class="col-lg-4"></div>
                            </div>
