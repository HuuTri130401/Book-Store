...
<head>
    ...
    <title>Staff Importation History</title>
...
<%--    Link Button CSS--%>
    ...
    <!-- link file CSS -->
    <link rel="stylesheet" href="./css/staffManageImportationHistory.css">
</head>
        ...
        <div class="seachbox-profile">
            <div class="wraper_searchbox_profile">
                <div class="search-box">
                    <form action="staffImportationAction?action=searchImportationHistory" method="POST">
                                ...
                                <c:if test="${i.import_Status==false}">
                                    ...
                                    <tr>
                                        ...
                                        <td><fmt:formatNumber value="${i.import_Detail_Price_Book}" type="number"/>
                                            <small style="text-decoration:underline">đ</small></td>
                                        <td><fmt:formatNumber value="${i.import_Detail_Total}" type="number"/>
                                            <small style="text-decoration:underline">đ</small></td>
                                        <td>${i.import_Date}</td>
                                        <td>${i.import_Note}</td>
